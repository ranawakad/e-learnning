...
<body>
    <h3 class="text-light ps-5 p-2 bg-dark">Available Courses</h3>
        <div class="container">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                ...
                <a type="button" class="btn btn-success col-4 m-1"  href = "/enrolling/{{$item->id}}" >Enroll</a>
                {{-- <form action="deleteEnrollments/2" method="post" class="col-3">
                    @method("Delete")
                    @csrf
